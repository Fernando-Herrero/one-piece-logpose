...
export const SideBar = () => {
    ...
    return (
        <aside
            ref={containRef}
            className="fixed flex flex-col w-fit h-[calc(var(--vh)*100)] bg-gradient-primary border-r-2 border-primary p-2 text-sm mt-11 pb-[calc(env(safe-area-inset-bottom)+1rem)] z-50 md:p-4 md:mt-13"
        >
