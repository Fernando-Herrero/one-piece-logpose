...
export const AvatarSelected = () => {
	...
	const characters = [
		...
		{ name: "Sanji", serious: [sanjiS400, sanjiS700, sanjiS1024], happy: [sanjiH400, sanjiH700, sanjiH1024] },
		{ name: "Usopp", serious: [usoppS400, usoppS700, usoppS1024], happy: [usoppH400, usoppH700, usoppH1024] },
	];
